...
from managerFunctions import add_contact,view_contact,delete_contact,search_contact,send_text
...
class MycontactManager(cmd.Cmd):
    ...
    title_intro = "Welcome To Contact Manager"
    prompt = "->>"
    file = None
    ...
    def do_add(self, args):
        ...
        try:
            managerFunctions.add_contact(args['<firstname>'],args['<lastname>'],args['<phone_no>'])
    ...
    def do_search(self,args):
        ...
        print(managerFunctions.search_contact(args['<firstname>']))

    @docopt_cmd
    def do_delete(self,args):
        """usage: delete <firstname>"""
        print(managerFunctions.delete_contact(args['<firstname>']))


    @docopt_cmd
    def do_view(self,args):
        """usage: view"""
        print(managerFunctions.view_contact())
